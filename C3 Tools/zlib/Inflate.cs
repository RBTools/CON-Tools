namespace C3Tools.zlib
{
	sealed class Inflate
	{
		...
		private static readonly byte[] mark = {(byte) 0, (byte) 0, (byte) SupportClass.Identity(0xff), (byte) SupportClass.Identity(0xff)};
		...
		internal int inflateSync(ZStream z)
		{
			...
			var r = z.total_in; var w = z.total_out;
			inflateReset(z);
