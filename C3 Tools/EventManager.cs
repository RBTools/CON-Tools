    ...
    public partial class EventManager : Form
    {
        ...
        private void LockForm(bool unlock)
        {
            ...
            try
            {
                ...
                btnPlay.Visible = !locked;
                btnEdit.Visible = !locked;
                btnDelete.Visible = !locked;
                btnDelPrev.Visible = !locked;
                btnEditPrev.Visible = !locked;
                btnStart.Visible = !locked;
                btnStop.Visible = !locked;
                btnEditPlay.Visible = !locked;
                btnSkip.Visible = !locked;
                TopMost = locked;
                MinimizeBox = !locked;
                MaximizeBox = !locked;
            }
