...
namespace C3Tools
{
    public partial class VideoPreparer : Form
    {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            packfiles.HeaderData.Description = "Created with C3 CON Tools for video recording purposes ONLY.";
        ...
        private void defaultTool_Click(object sender, EventArgs e)
        {
            ...
            c3WeeklyPreviewTool.Checked = false;
        }

        private void c3WeeklyPreviewTool_Click(object sender, EventArgs e)
        {
            chkRename.Text = "Change artist to 'VIDEO PREVIEW' to group songs together";
            txtTitle.Text = "Video Preview Pack - Week of " + PackDate;
            chkFTV.Enabled = true;
            defaultTool.Checked = false;
            c3WeeklyPreviewTool.Checked = true;
        }
