...
namespace C3Tools
{
    public partial class AdvancedArtConverter : Form
    {
        ...
        public AdvancedArtConverter(string Folder, Color ButtonBackColor, Color ButtonTextColor)
        {
            ...
            var formButtons = new List<Button> { btnRefresh, btnFolder, btnToPS3,btnFromPS3,btnToWii,btnFromWii,btnToXbox,btnFromXbox };
        ...
        private void txtFolder_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!imagesXbox.Any() && !imagesDDS.Any() && imageCount == 0 && !imagesWii.Any() && !imagesTPL.Any() && !imagesPS3.Any() && !miloXbox.Any() && !miloPS3.Any())
                {
                ...
                if (imageCount == 0)
                {
                    if (!imagesTPL.Any()) //!imagesXbox.Any() && !imagesDDS.Any() && !imagesPS3.Any() & 
                    {
                        btnToWii.Enabled = false;
                    }
        ...
        private void btnFolder_Click(object sender, EventArgs e)
        {
            ...
            folderUser.SelectedPath = txtFolder.Text;
            txtFolder.Text = "";
