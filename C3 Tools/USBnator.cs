...
namespace C3Tools
{
    public partial class USBnator : Form
    {
        ...
        private void extractFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var folder = new FolderBrowserDialog
            {
                ...
                Description = "Select folder to extract file(s) to",
                SelectedPath = Environment.CurrentDirectory
            };
            Environment.CurrentDirectory = folder.SelectedPath;
            if (folder.ShowDialog() != DialogResult.OK) return;
            ExtractFolder = folder.SelectedPath;
            GetFilesToExtract();
            EnableDisable(false);
