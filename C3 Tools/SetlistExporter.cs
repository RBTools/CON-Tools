...
namespace C3Tools
{
    public partial class SetlistExporter : Form
    {
        ...
        private void AddHeaderFooter(PdfContents Contents, int page_number)
        {
            ...
            if (chkC3.Checked)
            {
                Contents.DrawText(NormalFont, footersize, page_width - left_border, top_border - line_height, TextJustify.Right, "www.customscreators.com");
            }
        ...
        private void doPDFEspher(PdfDocument Document)
        {
            ...
            for (var i = 0; i < Songs.Count; i++)
            {
                ...
                foreach (var song in songs)
                {
                    var limit = chkC3.Checked || chkCountFooter.Checked || chkPages.Checked ? top_border + line_height : top_border; 
