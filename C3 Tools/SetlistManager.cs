    ...
    public partial class SetlistManager : Form
    {
        ...
        private bool SaveSetlist(string file, List<SongData> SongsToSave)
        {
            ...
            try
            {
                ...
                sw.WriteLine("CacheFormat=" + (doBlitzImport ? "Blitz_5" : "RB_5"));
        ...
        private void exportSetlist_Click(object sender, EventArgs e)
        {
            ...
            exporter.SetGame(modeRB4.Checked ? Resources.icon_rb4 : (modeRB3.Checked ? Resources.icon_rb3 : Resources.icon_blitz));
        ...
        private void doUpdateGameMode()
        {
            ...
            picGame.Image = modeRB4.Checked ? Resources.icon_rb4 : (modeRB3.Checked ? Resources.icon_rb3 : Resources.icon_blitz);
